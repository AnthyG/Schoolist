...
var precacheConfig = [
    ["/css/spectre.min.css", "e280dc6d09fd3c63aba5ed610073f838"],
    // ["/images/Schoolist_192(toofarup).png", "e84b289ae5114822495bfd574e810ea7"],
    // ["/images/Schoolist_192(tooshtty).png", "ad9cbb2c8379b8df305b0fa7adb57424"],
    // ["/images/Schoolist_192(toosmall).png", "2ff52b4264f299c5b27eded4d6ad76bd"],
    ["/images/Schoolist_192.png", "5896e79d02f0a073ca8577e1fa929c0a"],
    ["/images/apple-touch-icon-114x114.png", "849556dc3fbbb58e8d533af57961bf32"],
    ["/images/apple-touch-icon-120x120.png", "69f8aaa2ed37d4685db2d9c2c36cac03"],
    ["/images/apple-touch-icon-144x144.png", "f95bfe0fe3abf827c99c79b89bd430e3"],
    ["/images/apple-touch-icon-152x152.png", "6e8ad1f0e01b4b3da8ddb50b86b9a019"],
    ["/images/apple-touch-icon-57x57.png", "cb48ba1b8ff9730be7ed67228a402840"],
    ["/images/apple-touch-icon-60x60.png", "cdbfee78286887e088b3dc2e01905988"],
    ["/images/apple-touch-icon-72x72.png", "d4a768a42cdfdac1f3cca9a11d193dca"],
    ["/images/apple-touch-icon-76x76.png", "2ae4ceabf3a5382aba30807863a3d563"],
    // ["/images/favicomatic.zip", "c069b949769ffc488dccfdcf614f424c"],
    ["/images/favicon-128.png", "2eac332d7ce3e17bd44715fe51cb5baa"],
    ["/images/favicon-16x16.png", "f6f82577b53fe2f21741e1257cd4aa5e"],
    ["/images/favicon-196x196.png", "1f954e9e201df265c4ebc8ce6e8e30c2"],
    ["/images/favicon-32x32.png", "cce9b49c4eb23a3b43978b7644523e4f"],
    ["/images/favicon-96x96.png", "45395ad91336028e3772ac7d1c79daad"],
    ["/images/favicon.ico", "c7c6f211a58e339996a40b4e33b9d829"],
    ["/images/mstile-144x144.png", "f95bfe0fe3abf827c99c79b89bd430e3"],
    ["/images/mstile-150x150.png", "0af40081537acca1c247974e959edae7"],
    ["/images/mstile-310x150.png", "0659fbecd8749c0e9efd9cc5c4204151"],
    ["/images/mstile-310x310.png", "f0a0df0b705496f2d87d8cb09a772709"],
    ["/images/mstile-70x70.png", "2eac332d7ce3e17bd44715fe51cb5baa"],
    // ["/js/cachep2p.min.js", "e195fdc1da3e594789e965a8f4d46dbb"],
    // ["/js/cachep2p.security.js", "4530f768cab71e60bc84b94c2245d717"],
    // ["/js/d3.v3.min.js", "6ff33281add4acd55ed71a8a7d020bb1"],
    // ["/js/init.js", "1323c9918014b1537369d10266100347"],
    // ["/js/init.min.js", "47aeba49bcfff59bf8fdb847a3575830"],
    ["/js/jquery.min.js", "adcc4d0c3a34f2bf780e115939292153"],
    // ["/js/shell.js", "1991fc185bb16188d002dd9d1d91e3c1"],
    // ["/js/shell.min.js", "e339685d8a432303bce6dd5b2cc4e180"]
];
...
! function(e) {
    ...
    return function e(t, n, r) {
        function o(c, s) {
            if (!n[c]) {
                if (!t[c]) { var a = "function" == typeof require && require; if (!s && a) return a(c, !0); if (i) return i(c, !0); var u = new Error("Cannot find module '" + c + "'"); throw u.code = "MODULE_NOT_FOUND", u }
                var f = n[c] = { exports: {} };
                t[c][0].call(f.exports, function(e) { var n = t[c][1][e]; return o(n ? n : e) }, f, f.exports, e, t, n, r)
            }
            return n[c].exports
        }
        ...
        1: [function(e, t, n) {
            ...
            function o(e) { var t; return e && e.cache && (t = e.cache.name), t = t || d.cache.name, caches.open(t) }
            ...
            function h(e) { e instanceof Promise || p(e), d.preCacheItems = d.preCacheItems.concat(e) }
            ...
            t.exports = { debug: r, fetchAndCache: i, openCache: o, renameCache: a, cache: u, uncache: f, precache: h, validatePrecacheInput: p }
        ...
        2: [function(e, t, n) {
            ...
            function r(e) {
                return new Promise(function(t, n) {
                    ...
                    }, r.onsuccess = function() { t(r.result) }, r.onerror = function() { n(r.error) }
                })
            }
            ...
            function c(e, t, n) {
                return t ? new Promise(function(r, o) {
                    ...
                    }, s.oncomplete = function() { r(c) }, s.onabort = o
                }) : Promise.resolve([])
            }
            ...
            function s(e, t) {
                return t ? new Promise(function(n, r) {
                    ...
                    }, i.oncomplete = function() { n(o) }, i.onabort = r
                }) : Promise.resolve([])
            }

            function a(e, t, n, r) { return c(e, n, r).then(function(n) { return s(e, t).then(function(e) { return n.concat(e) }) }) }
            var u = "sw-toolbox-",
                f = 1,
                h = "store",
                p = "url",
        ...
        4: [function(e, t, n) {
            "use strict";
            var r;
            r = self.registration ? self.registration.scope : self.scope || new URL("./", self.location).href, t.exports = { cache: { name: "$$$toolbox-cache$$$" + r + "$$$", maxAgeSeconds: null, maxEntries: null }, debug: !1, networkTimeoutSeconds: null, preCacheItems: [], successResponses: /^0|([123]\d\d)|(40[14567])|410$/ }
        }, {}],
        5: [function(e, t, n) {
            "use strict";
            ...
            c.prototype.makeHandler = function(e) {
                ...
                if (this.regexp) {
                    ...
                    t = {}, this.keys.forEach(function(e, r) { t[e.name] = n[r + 1] })
                }
        ...
        6: [function(e, t, n) {
            ...
            ["get", "post", "put", "delete", "head", "any"].forEach(function(e) { s.prototype[e] = function(t, n, r) { return this.add(e, t, n, r) } }), s.prototype.add = function(e, t, n, c) {
                c = c || {};
                var s;
                ...
                for (var r = 0; r < t.length; r++) {
                    ...
                    if (i) { var s = c(i, n); if (s.length > 0) return s[0].makeHandler(n) }
                }
                return null
            }, s.prototype.match = function(e) { return this.matchMethod(e.method, e.url) || this.matchMethod("any", e.url) }, t.exports = new s
        }, { "./helpers": 1, "./route": 5 }],
        7: [function(e, t, n) {
            "use strict";

            function r(e, t, n) { return o.debug("Strategy: cache first [" + e.url + "]", n), o.openCache(n).then(function(t) { return t.match(e).then(function(t) { return t ? t : o.fetchAndCache(e, n) }) }) }
            var o = e("../helpers");
            t.exports = r
        }, { "../helpers": 1 }],
        8: [function(e, t, n) {
            ...
            function r(e, t, n) { return o.debug("Strategy: cache only [" + e.url + "]", n), o.openCache(n).then(function(t) { return t.match(e) }) }
            var o = e("../helpers");
            t.exports = r
        }, { "../helpers": 1 }],
        9: [function(e, t, n) {
        ...
        11: [function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                return i.debug("Strategy: network first [" + e.url + "]", n), i.openCache(n).then(function(t) {
                    var o, s, a = [];
                    if (c) {
                        var u = new Promise(function(n) { o = setTimeout(function() { t.match(e).then(function(e) { e && n(e) }) }, 1e3 * c) });
                        a.push(u)
                    }
                    var f = i.fetchAndCache(e, n).then(function(e) { if (o && clearTimeout(o), r.test(e.status)) return e; throw i.debug("Response was an HTTP error: " + e.statusText, n), s = e, new Error("Bad response") }).catch(function(r) { return i.debug("Network or response error, fallback to cache [" + e.url + "]", n), t.match(e).then(function(e) { if (e) return e; if (s) return s; throw r }) });
        ...
        12: [function(e, t, n) {
            ...
            function r(e, t, n) { return o.debug("Strategy: network only [" + e.url + "]", n), fetch(e) }
            var o = e("../helpers");
            t.exports = r
        }, { "../helpers": 1 }],
        13: [function(e, t, n) {
        ...
        15: [function(e, t, n) {
                ...
                for (var t, n = [], r = 0, o = 0, i = ""; null != (t = x.exec(e));) {
                    ...
                    if (i += e.slice(o, a), o = a + c.length, s) i += s[1];
                        ...
                        var v = null != h && null != f && f !== h,
                            ...
                            b = t[2] || "/",
                            E = l || d || (m ? ".*" : "[^" + b + "]+?");
                        n.push({ name: p || r++, prefix: h || "", delimiter: b, optional: y, repeat: w, partial: v, asterisk: !!m, pattern: u(E) })
                    }
                }
                return o < e.length && (i += e.substr(o)), i && n.push(i), n
            }

            function o(e) { return s(r(e)) }
            ...
            function s(e) {
                ...
                return function(n, r) {
                    for (var o = "", s = n || {}, a = r || {}, u = a.pretty ? i : encodeURIComponent, f = 0; f < e.length; f++) {
                        ...
                        if ("string" != typeof h) {
                            var p, l = s[h.name];
                            if (null == l) { if (h.optional) { h.partial && (o += h.prefix); continue } throw new TypeError('Expected "' + h.name + '" to be defined') }
                            if (v(l)) {
                                if (!h.repeat) throw new TypeError('Expected "' + h.name + '" to not repeat, but received `' + JSON.stringify(l) + "`");
                                if (0 === l.length) { if (h.optional) continue; throw new TypeError('Expected "' + h.name + '" to not be empty') }
            ...
            function l(e, t, n) { for (var r = [], o = 0; o < e.length; o++) r.push(m(e[o], t, n).source); var i = new RegExp("(?:" + r.join("|") + ")", h(n)); return f(i, t) }

            function d(e, t, n) { for (var o = r(e), i = g(o, n), c = 0; c < o.length; c++) "string" != typeof o[c] && t.push(o[c]); return f(i, t) }
            ...
            function g(e, t) {
                ...
                for (var n = t.strict, r = t.end !== !1, o = "", i = e[e.length - 1], c = "string" == typeof i && /\/$/.test(i), s = 0; s < e.length; s++) {
                    ...
                    if ("string" == typeof u) o += a(u);
                        ...
                        var f = a(u.prefix),
                            p = "(?:" + u.pattern + ")";
                        u.repeat && (p += "(?:" + f + p + ")*"), p = u.optional ? u.partial ? f + "(" + p + ")?" : "(?:" + f + "(" + p + "))?" : f + "(" + p + ")", o += p
                    }
                }
                return n || (o = (c ? o.slice(0, -2) : o) + "(?:\\/(?=$))?"), o += r ? "$" : n && c ? "" : "(?=\\/|$)", new RegExp("^" + o, h(t))
            }

            function m(e, t, n) { return t = t || [], v(t) ? n || (n = {}) : (n = t, t = []), e instanceof RegExp ? p(e, t) : v(e) ? l(e, t, n) : d(e, t, n) }
            var v = e("isarray");
